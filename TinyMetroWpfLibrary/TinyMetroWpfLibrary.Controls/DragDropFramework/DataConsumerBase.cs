...
namespace TinyMetroWpfLibrary.Controls
{
    ...
    {
        private static ILogService _logger = new FileLogService(typeof(DataConsumerBase));
        /// <summary>
        ...
        protected abstract void DragOverOrDrop(bool bDrop, object sender, DragEventArgs e);
    }
}
