...
namespace TinyMetroWpfLibrary.Controls
{
        ...
        where TSourceObject : UIElement
    {
        ...
        /// </summary>
        public virtual bool AddAdorner { get { return true; } }
        ...
        public virtual DragDropEffects AllowedEffects {
            get
            {
                return DragDropEffects.Move | DragDropEffects.Link | DragDropEffects.None;
            }
        }
        ...
        public virtual DataProviderActions DataProviderActions {
            get
            {
                return DataProviderActions.GiveFeedback | DataProviderActions.None;  
            }
        }
